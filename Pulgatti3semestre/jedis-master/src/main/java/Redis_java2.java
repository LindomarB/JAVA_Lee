...
public class Redis_java2 {
	public static void main(String[] args) { 
	      ...
	      String usuario="";
	      int escolha =tc.nextInt();tc.nextLine();
	      while(escolha!=0) {
		      if(escolha == 1) {
			      ...
			      System.out.println("2: criar novo usuario");
			      System.out.println("0: sair");
			      escolha =tc.nextInt();tc.nextLine();
		    }
	      	if(escolha == 2) {
		    	  System.out.println("Digite o apelido do usuario: ");
		    	  String apelido =tc.nextLine();
		    	  if(jedis.sadd("APELIDOS",apelido)==0) {
			    	  ...
			    	  String senha = tc.next();tc.nextLine();
	      ...
	      while(conectado==true) {
	    	  ...
	    	  if (s==1) {
	    		 ...
	    		 int ID=0;
	    		  ...
	    		  int qntd = tc.nextInt();tc.nextLine();
